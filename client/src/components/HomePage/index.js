...
const Home = () => {
    ...
    const successMessage = new URLSearchParams(window.location.search).get('status');
    ...
    return (
        ...
        <div className='bg-dark py-3'>
            <div className='container d-flex justify-content-center'>
                <div className='text-white h3'>HOME PAGE</div>
            </div>
        </div>
        <div className='container'>
            {successMessage &&
            <div className="mt-3 text-center alert alert-success alert-dismissible fade show" role="alert">Successfully {successMessage} User</div>
            }
                ...
                <tbody>
                {
                    students?.map((student)=>{
                        ...
                        <tr key={student.id}>
                            ...
                            <td onClick={() => navigate(`/Home?status=Deleted`)} ><button  className='delete-button'onClick={()=>{DeleteUser(student.id)}} >Delete</button></td> 
